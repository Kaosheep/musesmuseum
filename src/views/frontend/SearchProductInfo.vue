<template>
         ...
         <div class="backGroundCard">
            ...
            <div class="productInfo">
              ...
              <div v-for="(rowitem, rowindex) in productInfoArr" 
                :key="rowindex" 
                class="yellowRow">
                  <div class="itemInfoList">{{ rowitem.num }}</div>
  ...
  export default {
   ...
   data() {
     return {
      productInfoArr:[
          { num:"A00103",pic:"@/assets/image/productimage",name:"muses筆記", date:"2023/08/01",price:"$200",count:"2",total:"$400" },
          { num:"A00104",pic:"@/assets/image/productimage",name:"muses筆記", date:"2023/08/01",price:"$200",count:"2",total:"$400" },
          { num:"A00105",pic:"@/assets/image/productimage",name:"muses筆記", date:"2023/08/01",price:"$200",count:"2",total:"$400" },
          { num:"A00106",pic:"@/assets/image/productimage",name:"muses筆記", date:"2023/08/01",price:"$200",count:"2",total:"$400" },
          { num:"A00107",pic:"@/assets/image/productimage",name:"muses筆記", date:"2023/08/01",price:"$200",count:"2",total:"$400" },
