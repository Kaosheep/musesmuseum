    ...
    <div class="search">
       ...
       <div class="backGroundCard">
          ...
          <div class="productInfo">
            ...
            <div v-for="(rowitem, rowindex) in productInfoDetailArr" 
              :key="rowindex" 
              class="yellowRow">
...
export default {
 ...
 data() {
  ...
  productInfoDetailArr:[
        { id:"A00103",pic:"@/assets/image/productimage",name:"muses筆記", date:"2023/08/01",price:"$200",count:"2",total:"$400" },
        ...
        { id:"A00107",pic:"@/assets/image/productimage",name:"muses筆記", date:"2023/08/01",price:"$200",count:"2",total:"$400" },
 ...
 mounted() {
  ...
  // this.foundObject = this.productInfoDetailArr.find(item => item.id === idToFind);
