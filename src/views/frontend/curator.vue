...
export default {
      ...
      demos: [
        {
          ...
          dark: true,
          splitting: 'words',
          description: 'CSS • 3D • Animation',
          invert: true,
          loading: 'lazy',
          imageSrc: 'https://assets.codepen.io/383755/internal/screenshots/pens/xxVJZwo.default.png?fit=cover&format=auto&ha=true&height=540&quality=75&v=2&version=1569360312&width=960',
        },
        {
          title: 'Generative Patterns 8',
          dark: false,
          splitting: 'words',
          description: 'Generative • CSS Vars • GSAP',
          invert: false,
          loading: 'lazy',
          imageSrc: 'https://assets.codepen.io/383755/internal/screenshots/pens/wvGyKEY.default.png?fit=cover&format=auto&ha=true&height=540&quality=75&v=2&version=1599706499&width=960',
        },
  ...
  methods: {
    animateElement() {
      gsap.to('.your-element', { opacity: 0, duration: 1 });
    }
  }
};
</script>
